...
mahdi = {4736:0, 4719:0, 7267:45, 7625:0, 6709:0, 6793:0, 8645:0, 9580:60, 7777:0, 9200:0, 12370:75, 6101:40, 8700:60, 5400:0, 6700:0, 5800:0, 6451:0, 4800:0, 5900:0, 6450:35, 9700:60,
...
mxtime= max(mahdi.values())

for k,v in (mahdi.items()):
    Total_distance += k
    Total_Time +=v
    x +=1
    if v !=0:
...
mxrun = max(mahdi.keys())                                               # Max run and time in One Run
print('Max Distance in One Run :',mxrun,'in',mahdi.get(mxrun),'Min')
for k,v in mahdi.items():
    if v == mxtime:
